...
- **Python ADK: Streaming agent**
  ...
  [View Python Streaming Quickstart](https://adk.dev/live/get-started/streaming-python/index.md)
...
- **Java ADK: Streaming agent**
  ...
  [View Java Streaming Quickstart](https://adk.dev/live/get-started/streaming-java/index.md)
