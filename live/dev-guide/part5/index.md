...
For complete Event structure, see [Part 3: The Event Class](https://adk.dev/live/dev-guide/part3/#the-event-class).
...
For complete RunConfig reference, see [Part 4: Understanding RunConfig](https://adk.dev/live/dev-guide/part4/index.md).
...
When you disable VAD (which is enabled by default), you must use manual activity signals (`ActivityStart`/`ActivityEnd`) to control conversation turns. See [Part 2: Activity Signals](https://adk.dev/live/dev-guide/part2/#activity-signals) for details on manual turn control.
...
← [Previous: Part 4: Understanding RunConfig](https://adk.dev/live/dev-guide/part4/index.md)
