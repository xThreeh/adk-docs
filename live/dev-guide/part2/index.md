...
- **Images/Video**: Do NOT use `send_content()` with `inline_data`. Instead, use `send_realtime(Blob(mime_type="image/jpeg", data=...))` for continuous streaming. See [Part 5: How to Use Image and Video](https://adk.dev/live/dev-guide/part5/#how-to-use-image-and-video).
...
For complete details on audio, image and video specifications, formats, and best practices, see [Part 5: How to Use Audio, Image and Video](https://adk.dev/live/dev-guide/part5/index.md).
...
For detailed comparison of automatic VAD vs manual activity signals, including when to disable VAD and best practices, see [Part 5: Voice Activity Detection](https://adk.dev/live/dev-guide/part5/#voice-activity-detection-vad).
...
See [Part 4: Understanding RunConfig](https://adk.dev/live/dev-guide/part4/#streamingmode-bidi-or-sse) for detailed comparison and when to use each mode.
...
For comprehensive error handling patterns during streaming, including when to use `break` vs `continue` and handling different error types, see [Part 3: Error Events](https://adk.dev/live/dev-guide/part3/#error-events).
...
← [Previous: Part 1: Introduction to ADK Gemini Live API Toolkit](https://adk.dev/live/dev-guide/part1/index.md) | [Next: Part 3: Event Handling with run_live()](https://adk.dev/live/dev-guide/part3/index.md) →
