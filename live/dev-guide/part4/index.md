...
For detailed information about audio/video related `RunConfig` configurations, see [Part 5: Audio, Image and Video in Live API](https://adk.dev/live/dev-guide/part5/index.md).
...
| **speech_config**              | SpeechConfig                   | Voice and language configuration      | Both                       | [Part 5: Voice Configuration](https://adk.dev/live/dev-guide/part5/#voice-configuration-speech-config)             |
| **input_audio_transcription**  | AudioTranscriptionConfig       | Transcribe user speech                | Both                       | [Part 5: Audio Transcription](https://adk.dev/live/dev-guide/part5/#audio-transcription)                           |
| **output_audio_transcription** | AudioTranscriptionConfig       | Transcribe model speech               | Both                       | [Part 5: Audio Transcription](https://adk.dev/live/dev-guide/part5/#audio-transcription)                           |
| **realtime_input_config**      | RealtimeInputConfig            | VAD configuration                     | Both                       | [Part 5: Voice Activity Detection](https://adk.dev/live/dev-guide/part5/#voice-activity-detection-vad)             |
| **proactivity**                | ProactivityConfig              | Enable proactive audio                | Gemini (native audio only) | [Part 5: Proactivity and Affective Dialog](https://adk.dev/live/dev-guide/part5/#proactivity-and-affective-dialog) |
| **enable_affective_dialog**    | bool                           | Emotional adaptation                  | Gemini (native audio only) | [Part 5: Proactivity and Affective Dialog](https://adk.dev/live/dev-guide/part5/#proactivity-and-affective-dialog) |
...
- You must choose `AUDIO` for [Native Audio models](https://adk.dev/live/dev-guide/part5/#understanding-audio-model-architectures). If you want to receive both audio and text responses from native audio models, use the Audio Transcript feature which provides text transcripts of the audio output. See [Audio Transcription](https://adk.dev/live/dev-guide/part5/#audio-transcription) for details
...
- Supporting interruptions and natural turn-taking (see [Part 3: Handling Interrupted Flag](https://adk.dev/live/dev-guide/part3/#handling-interrupted-flag))
...
For details on which events are saved to the ADK `Session` versus which are only yielded during streaming, see [Part 3: Events Saved to ADK Session](https://adk.dev/live/dev-guide/part3/#events-saved-to-adk-session).
...
- Turn count tracking
- Custom cost monitoring by tracking token usage in model turn events (see [Part 3: Event Types and Handling](https://adk.dev/live/dev-guide/part3/#event-types-and-handling))
...
← [Previous: Part 3: Event Handling with run_live()](https://adk.dev/live/dev-guide/part3/index.md) | [Next: Part 5: How to Use Audio, Image and Video](https://adk.dev/live/dev-guide/part5/index.md) →
